...
== 使用VMware vCenter Server 6.7U1升級vCenter Server 4.8或更新版本之後發生NetApp Element 錯誤

升級NetApp Element 至VMware vCenter Server 6.7U1的vCenter Server 4.8或更新版本時、可能會遇到下列問題：
