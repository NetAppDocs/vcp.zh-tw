...
[role="lead"]
您可以依照安裝中所述的步驟升級適用於 vCenter Server 的NetApp Element插件。  NetApp Element vCenter 外掛程式 5.5 在 Element 和NetApp HCI版本之外作為管理服務包的一部分提供。
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["NetApp Element vCenter 外掛程式 5.5 發行說明"^]
...
* https://docs.netapp.com/us-en/element-software/index.html["零件與元件文件資源SolidFire"^]
