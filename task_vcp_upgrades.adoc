...
[role="lead"]
您可以依照安裝說明的步驟來升級NetApp Element vCenter Server的VMware vCenter外掛程式。vCenter Server 4.9版的選購項目可在Element和VMware版本之外取得、這是管理服務套裝組合的一部分。NetApp Element NetApp HCI
