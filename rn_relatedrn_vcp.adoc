...
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.76.10.html["運算韌體套裝組合2.76.10版本說明（最新）"^]
...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.99.2.html["儲存韌體產品組合2.99.2版本說明（最新）"^]
