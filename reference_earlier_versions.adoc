...
[role="lead"]
也提供了適用於 VMware vCenter Server 的NetApp Element插件 5.5 版之前的版本的文件。


NOTE: 這link:index.html["文件連結"]Element vCenter 外掛程式 5.5 還包括版本 5.4、5.3、5.2、5.1、5.0、4.10、4.9、4.8、4.7 和 4.6。
...
| 5.4 | https://library.netapp.com/ecm/ecm_download_file/ECMLP3330676["PDF"^] | https://library.netapp.com/ecm/ecm_download_file/ECMLP3330676["2.26.30"^] | link:index.html["連結"] 
