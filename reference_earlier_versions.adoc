...
[role="lead"]
也可取得早於 NetApp Element Plug-in for VMware vCenter Server 5.2 版的版本說明文件。


NOTE: 這 link:index.html["文件連結"] 對於 Element vCenter 外掛程式 5.2 、也包括 5.1 、 5.0 、 4.10 、 4.9 、 4.8 、 4.7 和 4.6 。
